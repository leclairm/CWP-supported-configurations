...
echo " - ML - DBG:: from script => PATH=${PATH}"
uenv run ${icon_uenv} --view default -- echo " - ML - DBG:: from within uenv run => PATH=${PATH}"
...
# Apply patches
# -------------
patch_dir="${original_dir}/build/patches)"
...
# Adapt build specs
# -----------------
echo "[build_and_squash] ...... Adapting build specs"
